	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-10 col-md-10 col-lg-offset-1 col-md-offset-1">
				<h3>Kho lưu trữ bài kiểm tra</h3>				
			</div>
		</div>
		<br/>		
		<div class="row">
						...
						<div class="panel-body" style="padding:0px">							
							<table style="width:100%;padding:0px">
								...
								<?php foreach($data['tests'] as $fi){ ?>
									<tr class="groups">
										<td class="col-body">												
											<a href="/bai-nop?id=<?php echo $fi['id'] ?>" style="font-size:11pt;"><span class="glyphicon glyphicon-folder-open"></span>&nbsp;&nbsp;<?php echo $fi['title'] ?></a>
										</td>
