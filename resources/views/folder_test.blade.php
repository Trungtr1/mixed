						...
						<div class="panel-body" style="padding:0px">							
							<table style="width:100%;padding:0px">
								...
								<?php foreach($data['tests'] as $fi){ ?>
									<tr class="groups">
										<td class="col-body">												
											<a href="/testing?id=<?php echo $fi['id'] ?>" style="font-size:11pt;"><span class="glyphicon glyphicon-list-alt" style="color:#000"></span>&nbsp;&nbsp;<?php echo $fi['title'] ?></a>
										</td>
										<td class="col-body tct">
											<span style="color:#A9A9A9"><?php echo $fi['date'] ?><span>
										</td>
										<td class="col-body tct">
											<button type="button" class="btn btn-warning btn-sms" data-toggle="modal" data-target="#modal_sms" data-id="<?php echo $fi['id'] ?>"><span class="glyphicon glyphicon-send"></span> &nbsp;Gửi bài</button>
										</td>
									</tr>
								<?php } ?>
							</table>						
