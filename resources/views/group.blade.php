	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12">
				<h3>
				<span class="glyphicon glyphicon-list-alt"></span>&nbsp;&nbsp;<a href="/user?id=<?php echo $data['user']['id'] ?>"><?php echo $data['user']['fullname'] ?></a>&nbsp;/&nbsp;<?php echo $data['folder'][0]['name'] ?>
				</h3>
				<hr>
			</div>
		</div>
									...
									<?php foreach($data['children'] as $ch){ ?>
										<tr class="groups">
											...
											<td style="border-bottom:1px solid #ccc;text-align:center;width:120px">
												<a href="/folder?action=like&id=<?php echo $ch['id'] ?>">
												...
												<a href="/folder?action=delete&id=<?php echo $ch['id'] ?>" onclick="return confirm('Are you sure you want to delete this item?');">
									...
									<?php foreach($data['files'] as $fi){ ?>
										<tr class="groups">
											...
											<td style="border-bottom:1px solid #ccc;text-align:center;width:120px">
												...
												<a href="/file?action=delete&id=<?php echo $fi['id'] ?>" onclick="return confirm('Are you sure you want to delete this item?');">
													<button type="button" title="xóa" name="xoa" style="border:0px;background:none;"><span style="color:#e44b23" class='glyphicon glyphicon-trash'></span></button>
												</a>
											</td>
										</tr>
